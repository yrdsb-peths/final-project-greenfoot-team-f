...
public class Hitsu extends Actor implements Enemy 
{
    ...
    public Hitsu(MainPlayer player) 
    {
        ...
        attackFrames = loadFrames("hitsuAttack_", 12); // 12 frames (00 to 11)
    ...
    public void performAttack() 
    {
        ...
        EnemyProjectile projectile = new EnemyProjectile("image_250-removebg-preview.png", facingRight, 25);
        attackSound.play();
